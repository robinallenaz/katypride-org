        ...
        <div className="bg-white/80 backdrop-blur-md rounded-3xl border border-black/5 shadow-xl p-8 md:p-10">
          ...
          <section className="mt-10">
            ...
            <ul className="grid gap-3">
              <li>
                <a
                  href="https://www.katyisd.org/board/election/home"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-heading text-lg text-gray-900 underline decoration-purple-300 underline-offset-4 hover:text-purple-950 hover:decoration-purple-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                >
                  Katy ISD General Election Information
                </a>
              </li>

              <li>
                <a
                  href="https://resources.finalsite.net/images/v1745885376/katyisdorg/kplvd6zlryq98vo8a3gm/katy_isd_polling_locations_2025.pdf"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-heading text-lg text-gray-900 underline decoration-purple-300 underline-offset-4 hover:text-purple-950 hover:decoration-purple-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                >
                  Katy ISD 2026 Polling Locations
                </a>
              </li>

              <li>
                <a
                  href="https://www.katyisd.org/board/board/board-meeting-dates"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-heading text-lg text-gray-900 underline decoration-purple-300 underline-offset-4 hover:text-purple-950 hover:decoration-purple-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                >
                  Katy ISD Board Meeting Dates
                </a>
              </li>

              <li>
                <a
                  href="https://www.katyisd.org/board/board/addressing-the-board"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-heading text-lg text-gray-900 underline decoration-purple-300 underline-offset-4 hover:text-purple-950 hover:decoration-purple-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-purple-500"
                >
                  How to Address the Katy ISD Board
                </a>
              </li>
