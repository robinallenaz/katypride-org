...
export interface ApiCalendarSettingCalendarSetting
  ...
  info: {
    description: 'Google Calendar embed settings for the /calendar page. Only one entry needed.';
  ...
  attributes: {
    calendarDescription: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'View upcoming Katy Pride events...'>;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showSubscribeButtons: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    timeZone: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'America/Chicago'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCarouselImageCarouselImage
  ...
  info: {
    description: 'Homepage hero carousel images. Toggle isActive to show/hide images.';
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Community events displayed on the /events page. Includes Espresso Yourself meetups and special events like Chase the Rainbow 5K.';
    displayName: 'Event';
    pluralName: 'events';
    singularName: 'event';
  };
...
export interface ApiResourceLinkResourceLink
  ...
  info: {
    description: 'LGBTQ+ resources shown on the /resources page. Categorized by health, advocacy, ally, regional, and national.';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['health', 'advocacy', 'ally', 'regional', 'national']
    > &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
